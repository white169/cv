...
img1 = cv.imread(r'C:/Users/user/Desktop/PERANTIS ISKANDAR/Assignments/Project/image_face_detection/class.png')
img = img1.copy()
# image dimension
h, w = img.shape[:2]
...
for i in range(0, detections.shape[2]):
    ...
    if confidence > 0.6:
        ...
        cv.putText(img, text+ "person", (x1, y), cv.FONT_HERSHEY_SIMPLEX, 0.8, (255, 0, 255), 2)
...
plt.show()
#cv.imwrite("output_image",imgRGB)